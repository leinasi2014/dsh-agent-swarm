...
- 当前全量为 203 项测试 / 34 个测试文件；`tests/executable-review.spec.ts` 的 17 项覆盖 #101 全部回归及 #128 的模板展开、Node/Python 混合根、Python 不可用的提交前拒绝、聚合完整性和诊断截断后 verdict/provenance 保留。
