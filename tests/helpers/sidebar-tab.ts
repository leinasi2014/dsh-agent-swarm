...
export function tabInfoFixture(id = 'tab-3', close: () => void = () => {}): SidebarRightTabInfo {
  return { sidebar: { expanded: true, fullscreen: false }, panel: { id: 'pane-1' as SidebarRightTabInfo['panel']['id'] },
    tab: { id: id as SidebarRightTabInfo['tab']['id'], kind: 'swarm-team', contentId: 'dsh-page://swarm-team', title: 'Team', visible: true,
