...
export async function apply(ctx: Context, config: ConfigInput): Promise<void> {
  ...
  const runtime = new AgentSwarmRuntime(ctx, {
    ...
    limits: {
      ...
      maxPublicSegments: config.maxPublicSegments ?? DEFAULT_TEAM_LIMITS.maxPublicSegments,
      maxDirectoryReadConcurrency: config.maxDirectoryReadConcurrency ?? DEFAULT_TEAM_LIMITS.maxDirectoryReadConcurrency,
      maxDirectoryReadMs: config.maxDirectoryReadMs ?? DEFAULT_TEAM_LIMITS.maxDirectoryReadMs,
      maxDirectoryEntryReadMs: config.maxDirectoryEntryReadMs ?? DEFAULT_TEAM_LIMITS.maxDirectoryEntryReadMs,
