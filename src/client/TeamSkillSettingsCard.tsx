...
export const teamSkillSettingsZh: Record<keyof typeof teamSkillSettingsEn, string> = {
  ...
  memberProvider: '队员运行 Provider', maxMembers: '每个团队最多成员数', maxTasks: '每个团队最多任务数', memberDepth: '队员子智能体层级', pendingMessages: '每名队员待处理消息上限', identityPolicy: '身份与头像策略', identityPolicyValue: '队长负责初始化与检查资料；成员自行补全信息，并按喜好设计头像：人物、动物、物品或抽象图案均可，统一为 32×32 点阵格式，配色协调。',
