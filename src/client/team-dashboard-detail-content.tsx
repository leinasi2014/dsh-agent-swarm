...
export function DetailOverlay({ detail, data, localeTag, number, headingRef, memberAssets, diagnostics, onClose, onKeyDown, t }: {
...
function onTabCycle(event: KeyboardEvent<HTMLDivElement>): void {
