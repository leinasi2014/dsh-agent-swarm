 ...
 * before the child starts, activation settles only after the child's initial
 * terminal turn, and every failure path settles the record failed and drains
 * an uncommitted child where one remains.
 *
