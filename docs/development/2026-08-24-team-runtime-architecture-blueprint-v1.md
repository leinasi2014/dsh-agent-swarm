...
Accepted A1a base: repository commit `e72f0344191360aef56b9055da63cb88544ba64e`. A1b is frozen at `e436e38d44374b46861174f4d494595c3854bcc8` with isolated official Profile evidence and two non-author PASS verdicts; its claim remains `DEV_SMOKE_ONLY`, not release acceptance. The following A2a online continuation work remains an unfrozen, config-gated implementation candidate. Commit `6b0e96b8c46213d9898734c464da54bf2b4b649a` passed a clean official Profile development smoke but failed two non-author reviews on semantic idempotency, receipt retention, bounded disposal and a knowledge-graph drift lock. Commit `9c25e9cc892862a63238b7ae014fe319d4f763ec` corrected those defects but failed follow-up review because receipt capacity was reserved only after the Provider effect. The next candidate moves that reservation into the admission transaction before followup/model dispatch. No A2a acceptance is claimed, and neither Profile smoke exercised cold recovery or ambiguous external-delivery reconciliation. Official DSH `0.1.1-rc.2` / `b150a551b8d465e31e418e1b2eaf5e79bbb7d28e` is the untouched verification host. JiuwenSwarm is reviewed and pinned at `ea3b740173c74e4cd4e8939ae546cfec3ebb7d80`; dsh-agent-teams is reviewed and pinned at `912aae5225d3d85fa841a1b0c8a5c77021876c25` / `0.1.13`. LoopX is a remote, non-dependency reference whose relevant control-plane and native-DSH surfaces were reviewed at `6aa2fb8a9fb97f0bfa6ee8b0ca6fabf6265bbe95`. Gate A passes for the locally registered pins; implementation candidates still require milestone-specific non-author acceptance.
