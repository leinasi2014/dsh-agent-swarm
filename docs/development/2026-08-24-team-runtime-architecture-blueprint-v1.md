...
- **A2a continuation:** accepted online candidate `e15a3fd`, accepted cold entered-dispatch candidate `1d27deb` and accepted recovery-reservation candidate `8c18fea` cover typed same-Attempt intent, official followup/claim, model-entry witness, entered-outcome reconciliation and proof-bound recovery staging. The R1c candidate adds absent-only typed recovery delivery, atomic claimed-frame handoff, Provider/assistant settlement and cold claimed-frame folding. A durable pending-but-unclaimed trigger remains blocked without an official resume-only seam; the next slices are submit/reassign/cancel competition and unknown Provider/result handling. No elapsed-time wake or manager approval is added.
