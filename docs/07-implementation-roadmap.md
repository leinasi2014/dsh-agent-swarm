...
部门与资料室重构的设计基线及 A–D 切片出口见 [重构规范 01](refactoring/01-departments.md)。长期员工、岗位记忆、Skills 提炼、独立审计及未决业务边界仍见 [能力边界 §10](03-capability-family.md#department-spec)。先讨论 DEP-O02 性格与工作方式，再讨论 DEP-O03 自主行动及协作范围；文档定稿不代表实现、验收或发布，具体技术接入由架构负责人验证。
