...
Rebased: 2026-08-20 against official DSH `141eb6fef83422698aef7a981029e843e8161534`, `dsh-agent-teams` `801954dd7be67213cf4adc1aeb6f97bd3daa12cc` and JiuwenSwarm `b7378eb48cdc8ffa363778cb918a891ceb96fcfd`. ADR-0008 adds staged self-hosting readiness and renumbers the post-M2 milestones.
...
Exit: F4, F8, F10 and accepted companion findings pass lifecycle, scheduling, prompt snapshot and compatibility tests. F4, F11-F15, usage coalescing, the #19 official-compat semantics group and F10 (live-status scheduling with stranded-ownership self-healing, #12) are closed; F8 (prompt delimiting) remains open.
