...
Exit: F4, F8, F10 and accepted companion findings pass lifecycle, scheduling, prompt snapshot and compatibility tests. F4, F11-F15, usage coalescing, the #19 official-compat semantics group, F10 (live-status scheduling with stranded-ownership self-healing, #12) and F8 (untrusted-content delimiting + prompt snapshots, #14) are closed; only the #15 model-experience issue remains in M1C.
