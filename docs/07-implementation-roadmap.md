...
Exit: F4, F8, F10 and accepted companion findings pass lifecycle, scheduling, prompt snapshot and compatibility tests. F4, F11-F15, usage coalescing and the #19 official-compat semantics group are closed; F8 (prompt delimiting) and F10 (live-status scheduling) remain open.
